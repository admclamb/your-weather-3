  ...
  return (
    <>
      <div className="border flex rounded-full py-0 px-0 items-center justify-center">
        <button
          className="flex justify-center items-center w-8 h-8 rounded-full hover:bg-gray-100 active:bg-gray-200 duration-200 ease-out focus:outline outline-2 outline-offset-2 outline-orange-600"
          data-type="decrement"
